<template>
  <div class="bg_img" style="height: 100%">
    <div id="logo"></div>
    <div id="scroller" style="text-align: center; width: 600px; font-family: Staatliches, sans-serif" class="d-flex justify-center align-content-center">
      <div>
        <p>
          BARRÉ Martin
        </p>
